...
class Algorithm {
  public:
    ...
    Algorithm(Data &data, int model_type, int ag_type, int max_iter = 100) {
        this->data = data;
...
public:
  L0L2Lm(Data &data, unsigned int ag_type, unsigned int max_iter = 20) : Algorithm(data, 1, ag_type, max_iter) {
    //cout<<"L0L2Lm"<<endl;
    }
   ...
   void get_A(Eigen::MatrixXd X, Eigen::VectorXd y, Eigen::VectorXd beta, double coef0, int T0, Eigen::VectorXd weights,
    ...
    void primary_model_fit(Eigen::MatrixXd X, Eigen::VectorXd y, Eigen::VectorXd weights, Eigen::VectorXd &beta, double &coef0)
    {
        ...
        //cout<<"X.adjoint()*X: "<<X.adjoint()*X<<endl;
...
public:
  L0L2Logistic(Data &data, unsigned int ag_type,unsigned int max_iter = 20, int model_fit_max = 1e6) : Algorithm(data, 2, ag_type, max_iter) {
    this->model_fit_max = model_fit_max;
  };
...
public:
  L0L2Poisson(Data &data, unsigned int ag_type, unsigned int max_iter = 20, int model_fit_max = 1e6) : Algorithm(data, 3, ag_type, max_iter) {
    this->model_fit_max = model_fit_max;
  };
...
public:
  L0L2Cox(Data &data, unsigned int ag_type, unsigned int max_iter = 20, int model_fit_max = 1e6) : Algorithm(data, 4, ag_type, max_iter) {
    this->model_fit_max = model_fit_max;
  };
...
public:
  GroupPdasLm(Data &data, unsigned int ag_type, unsigned int max_iter = 20) : Algorithm(data, 1, ag_type, max_iter) {}
  ...
  void get_A(Eigen::MatrixXd X, Eigen::VectorXd y, Eigen::VectorXd beta, double coef0, int T0, Eigen::VectorXd weights,
    ...
    vector<Eigen::MatrixXd> PhiG = this->PhiG;
    vector<Eigen::MatrixXd> invPhiG = this->invPhiG;
    PhiG = (this->ag_type == 2) ? this->PhiG : Phi(X, index, gsize, n, p, N, this->lambda_level);
    invPhiG = (this->ag_type == 2) ? this->invPhiG : invPhi(PhiG, N);
    Eigen::VectorXd betabar = Eigen::VectorXd::Zero(p);
    Eigen::VectorXd dbar = Eigen::VectorXd::Zero(p);
    Eigen::VectorXd bd = Eigen::VectorXd::Zero(N);
    Eigen::VectorXd d = X.transpose()*(y-X*beta)/double(n) - 2*this->lambda_level*beta;
    vector<int> A(T0, -1);
...
public:
  GroupPdasLogistic(Data &data, unsigned int ag_type, unsigned int max_iter = 20, int model_fit_max = 1e6) : Algorithm(data, 2, ag_type, max_iter) {
    this->model_fit_max = model_fit_max;
  };
...
public:
  GroupPdasPoisson(Data &data, unsigned int ag_type, unsigned int max_iter = 20, int model_fit_max = 1e6) : Algorithm(data, 3, ag_type, max_iter) {
    this->model_fit_max = model_fit_max;
  };
...
public:
  GroupPdasCox(Data &data, unsigned int ag_type, unsigned int max_iter = 20, int model_fit_max = 1e6) : Algorithm(data, 4, ag_type, max_iter) {
    this->model_fit_max = model_fit_max;
  };
