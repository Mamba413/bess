...
#'
#' For \code{family = "poisson"} , the data model is \deqn{Y = Exp(exp(X \beta +
#' \epsilon)).}
#'
#'  For \code{family = "cox"}, the data model is
#'\deqn{T = (-log(S(t))/exp(X \beta))^{1/scal}.}
#'The centerning time is generated from uniform distribution \eqn{[0, c]},
...
#' gaussian data.\code{"binomial"} for binary data. \code{"poisson"} for poisson data. \code{"cox"}
#' for survival data.
...
#' @param SNR Gaussian noise \eqn{\epsilon} with mean 0 and variance. Default is \code{10}.
...
#' @param censoring Whether data is censored or not. Default is \code{TRUE}.
