...
class bess_base:
    def __init__(self, algorithm_type, model_type, path_type, max_iter=20, exchange_num=0, is_warm_start=True,
                 ...
                 ic_type="ebic",
                 is_cv=False, K=5, is_screening=False, powell_path=1):
    ...
    def fit(self, X, y, is_weight=False, is_normal=True, weight=None, state=None, group=None):
        ...
        # print("path type" + str(self.path_type_int))
        ...
        result = pywrap_bess(X, y, self.data_type, weight,
                             ...
                             self.is_screening, self.powell_path,
                             p,
                             1, 1, 1, 1, 1, 1, p
                             )
...
class PdasLm(bess_base):
    ...
    def __init__(self, max_iter=20, exchange_num=0, path_type="seq", is_warm_start=True, sequence=None, lambda_sequence=None, s_min=None, s_max=None,
                 K_max=None, epsilon=0.0001, lambda_min=None, lambda_max=None, ic_type="ebic", is_cv=False, K=5, is_screening=False, powell_path=1
                 ):
        super(PdasLm, self).__init__(
            ...
            epsilon=epsilon, lambda_min=lambda_min, lambda_max=lambda_max, ic_type=ic_type, is_cv=is_cv, K=K, is_screening=is_screening, powell_path=powell_path)
        self.data_type = 1
